...
docker run --name my-spark-app -e ENABLE_INIT_DAEMON=false --link spark-master:spark-master --net docker-spark_default -d spark-app
```
...
#### Example Dockerfile
```
FROM spark-python-template:3.1.1-hadoop3.2
