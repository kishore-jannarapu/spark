...
with DAG(DAG_NAME,
    ...
    create_model = BashOperator(
        ...
        bash_command='spark-submit --class com.datamantra.spark.jobs.FraudDetectionTraining --name "Fraud Detection Spark ML Training" --master spark://spark-master:7077  --total-executor-cores 1' + ' ' + home + '/FraudDetection/build-files/spark/fruaddetection-spark.jar' + ' ' + home + '/FraudDetection/build-files/spark/application-local.conf',
        default_args=default_args)
